                        ...
                        @else                
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="{{ route('formateur.logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form-2').submit();">Logout</a>
                                    <form id="logout-form-2" action="{{ route('formateur.logout') }}"  style="display: none;">
                                        @csrf
                                    </form>
                                </div>
                            </div>
